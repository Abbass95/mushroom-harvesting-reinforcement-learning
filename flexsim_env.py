...
class FlexSimEnv(gym.Env):
    ...
    def __init__(self, flexsimPath, modelPath, address='localhost', port=5005, verbose=False, visible=False):
        ...
        #self.observation_space.dtype = np.float64
        #print("Observation space data type:",self.observation_space.dtype)
    ...
    def reset(self):
        ...
        print('printing reset:' ,state, done)
        return state

    def step(self, action):
        #time.sleep(0.1)                    #added by abbass
